...
//            LoggerLog(new Exception("cannot find method : " + methodName + "(for class : " + clazz.getName() + ")"));
    ...
    public static void disableMethod(@NonNull Method m, @NonNull Class<?> selfClass){
    ...
    public static void disableClass(@NonNull Class<?> selfClass){
    ...
    public static void listenClass(@NonNull Class<?> selfClass){
        if (Modifier.isAbstract(selfClass.getModifiers()) || Modifier.isInterface(selfClass.getModifiers())){return;}
        XposedBridge.hookAllConstructors(selfClass, new XC_MethodHook() {
            @Override
            protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
                super.beforeHookedMethod(param);
                LoggerLog(new Exception("listening constructor: "+selfClass.getName()));
            }
        });
        for (Method m:selfClass.getDeclaredMethods()){
    ...
    public static void listenMethod(@NonNull Method m,@NonNull Class<?> selfClass){
